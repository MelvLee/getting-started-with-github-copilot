...
activities = {
    ...
    "Basketball Team": {
        "description": "Develop ball handling skills and play competitive basketball games",
    ...
    "Art Club": {
        "description": "Create paintings, sketches, and other visual art projects",
...
def signup_for_activity(activity_name: str, email: str):
    ...
    # Validate studen t is not already signed up
